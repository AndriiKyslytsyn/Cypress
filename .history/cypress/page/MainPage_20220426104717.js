class MainPage {
    ...
    async logintoStep() {
        await cy.visit(this.baseURL);
        await cy.get(this.usernameInput).clear();
        await cy.get(this.usernameInput).type(credentialsJunit.username);
        await cy.get(this.passwordInput).clear();
        await cy.get(this.passwordInput).type(credentialsJunit.password);
        await cy.get(this.submitButton).click()
        await cy.wait(500);
    }
